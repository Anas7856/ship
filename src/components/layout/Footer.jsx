            ...
            <a href="/">
              ...
              <div className="space-y-3">
                ...
                {/* <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Henry@valhallalogisticllc.com</span>
                </div> */}
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                  <Mail className="w-5 h-5 text-blue-400" />
                  <span className="text-gray-300">Henry@vallhallalogisticllc.com</span>
                </div>
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className="text-gray-300 hover:text-blue-400 transition-colors duration-100"
                  >
