          ...
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Henry@vallhallalogisticllc.com</span>
              </div>
            </nav>
            ...
            <div className="hidden md:flex">
              <button 
                onClick={() => handleNavigation('/agreement')}
                className="bg-blue-900 text-white px-6 py-3 rounded-lg hover:bg-blue-800 transition-colors duration-200 font-medium flex items-center gap-2"
              >
