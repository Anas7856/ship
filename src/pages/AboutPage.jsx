...
const values = [
  ...
  },
  {
    ...
    title: 'Reliability',
    description: 'We deliver on our promises, ensuring timely and dependable service.',
  },
];
  ...
  <main className="about-page">
    ...
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          <span className="text-blue-700 font-semibold uppercase tracking-wide">Our Story</span>
          <h2 className="text-4xl font-bold mt-2 mb-3">Who We Are</h2>
          <div className="w-16 h-1 bg-blue-200 mb-6"></div>
          <p className="text-gray-700 mb-4">
            VALHALLA LOGISTICS LLC. was founded with a vision to revolutionize the logistics and transportation industry.
            Our journey began with a simple mission: to provide reliable, efficient, and cost-effective brokerage services
            that connect businesses with the right carriers for their shipping needs.
          </p>
          <p className="text-gray-700">
            With years of experience in the industry, our team of dedicated professionals understand the challenges
            businesses face when it comes to shipping and logistics. We've built our reputation on trust, reliability,
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row-reverse items-center gap-12">
        ...
        <div className="flex-1">
          <span className="text-blue-700 font-semibold uppercase tracking-wide">Our Purpose</span>
          <h2 className="text-4xl font-bold mt-2 mb-3">Mission & Vision</h2>
          <div className="w-16 h-1 bg-blue-200 mb-6"></div>
          <p className="mb-2">
            <strong>Our Mission:</strong> To provide innovative logistics solutions that optimize supply chains,
            reduce costs, and improve efficiency for businesses of all sizes.
          </p>
          <p className="mb-6">
            <strong>Our Vision:</strong> To become the leading brokerage company known for reliability, transparency,
    ...
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <span className="text-blue-700 font-semibold uppercase tracking-wide">The People Behind Our Success</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {leadershipTeam.map((member, idx) => (
            <div key={idx} className="bg-gray-50 rounded-xl shadow p-6 flex flex-col items-center">
              <img
                src={member.image}
                alt={member.name}
    ...
    <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-800">
      <div className="max-w-4xl mx-auto px-4 text-center text-white">
        ...
        <p className="mb-8 text-blue-100">
          Contact us today to learn how we can help optimize your shipping and logistics operations.
        </p>
